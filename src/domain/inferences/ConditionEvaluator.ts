...
/** Builds the pass-invariant lookups once per pass; reused by `conditionHolds`/`conditionIsApplicable`. */
export function buildLookups(context: CheckInContext): EvaluatorLookups {
...
export function conditionHolds(
  ...
  const loot = lookups ?? buildLookups(context);
...
export function conditionIsApplicable(
  condition: Condition,
  context: CheckInContext,
  lookups?: EvaluatorLookups,
): boolean {
