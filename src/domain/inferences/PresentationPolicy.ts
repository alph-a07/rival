...
/**
 * The only UI-deciding component in the inference package.
...
export class PresentationPolicy {
  static deriveQuestionPresentation(
    ...
    const resolve = top ? this.resolveOption(sorted) : null;
